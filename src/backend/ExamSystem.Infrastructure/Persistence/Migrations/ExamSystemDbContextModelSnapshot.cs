...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExamSystem.Domain.Entities.McqAggregate.MultipleChoiceQuestion", b =>
                {
                    ...
                    b.ToTable("MultipleChoiceQuestions", null, t =>
                        {
            ...
            modelBuilder.Entity("ExamSystem.Domain.Entities.McqAggregate.MultipleChoiceQuestionOption", b =>
                {
                    ...
                    b.ToTable("MultipleChoiceQuestionOption", null, t =>
                        {
                            t.HasCheckConstraint("CK_MultipleChoiceQuestionOption_BodyType_Enum", "[BodyType] IN (0, 1)");
                        });
                });
            ...
            modelBuilder.Entity("ExamSystem.Domain.Entities.McqAggregate.MultipleChoiceQuestionTag", b =>
                {
                    ...
                    b.ToTable("MultipleChoiceQuestionTag", (string)null);
                });
            ...
            modelBuilder.Entity("ExamSystem.Domain.Entities.UnaryAggregateRoots.SystemClaim", b =>
                {
                    ...
                    b.ToTable("SystemClaims", (string)null);
            ...
            modelBuilder.Entity("ExamSystem.Domain.Entities.UnaryAggregateRoots.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ExamSystem.Domain.Entities.McqAggregate.MultipleChoiceQuestionTag", b =>
                {
                    ...
                    b.HasOne("ExamSystem.Domain.Entities.UnaryAggregateRoots.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
